...
and photometric data sets (cite Kelson ??, Kirkman/O'Meara ??, 
Bolton et al. 2005, Davis/Newman/Finkbeiner).  We also extend the 1-dimensional
...
the extreme range of the independent variable domain, and the B-spline 
...
in the slatec library (ref??) and translated completely to IDL.
