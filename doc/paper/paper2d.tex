...
\author{
David J. Schlegel\altaffilmark{\ref{LBL}}
and Scott Burles\altaffilmark{\ref{email}}
}
\altaffiltext{1}{sburles@gmail.com \label{sburles}}
\altaffiltext{2}{Lawrence Berkeley National Laboratory,
1 Cycltotron Road, Berkeley, CA 94720 \label{LBL}}
...
\begin{abstract}
We describe the data reduction pipeline for the spectroscopic data
reduction for the optical spectrographs on the Sloan Telescope.
These spectrographs were used to obtain spectra of 900,000 galaxies,
100,000 QSOs and 300,000 stars during the Sloan Digital Sky Survey
(SDSS) and Sloan Digital Sky Survey II (SDSS-II) from 1999 through 2009.
The instrument was rebuilt in 2009 for the Sloan Digital Sky Survey III
(SDSS-III) and will be used to complete a survey of an additional
1.35 million galaxies and 200,000 QSOs by 2014.
We present the pipeline design and algorithms for reducing the raw
data to wavelength-calibrated, flux-calibrated one-dimensional spectra
and per-pixel error estimates.
The pipeline has been used to automatically reduce the survey data
sets and output uniformly-processed results.
The wavelength calibration is demonstrated to have an accuracy
of $3\kms$ and the broad-band spectrophotometry to have an accuracy
of $6\%$ for SDSS-I and II and $9\%$ for SDSS-III.
These spectra are of sufficient quality to allow automated redshift
fits to $99\%$ of the galaxies in SDSS-I and II and $\98\%$ of the much
fainter galaxies in SDSS-III, and catestrophic redshift errors
of much less than $1\%$ in all cases.
...
\label{sec_intro}
The Sloan Telescope was designed to provide 5-band imaging
of approximately one-quarter of the sky and spectroscopic follow-up
of millions of galaxies, QSOs and stars in that same footprint.
The original SDSS operated from 1998-2005 and
imaged 7600 deg$^2$ with spectroscopic follow-up of ???.
SDSS-II operated from 2005-2008 as a combination of three programs:
spectroscopic follow-up in the remainder of the original SDSS footprint,
a supernova search from repeated imaging of an equatorial stripe,
and imaging and spectroscopic follow-up for Galactic stars (SEGUE).

The SDSS spectroscopic pipeline (idlspec2d) was written in support
of the original galaxy and QSO redshift survey.
This pipeline was modified to provide more accurate redshifts
and spectrophotometry in support of the SEGUE program in SDSS-II.
The pipeline was again modified to support the rebuilt spectrographs
for the Baryon Oscillation Spectroscopic Survey (BOSS) in SDSS-III,
which is observing targets 2.5 mag fainter than SDSS.
Finally, many of the algorithms and code have been used for
the spectroscopic reductions of the DEEP2 survey.

The pipeline is written in the IDL language with some C bindings.
It makes use of the Goddard IDL astronomy library.
The code and all previous versions are publicly-available
through the SDSS-III project at {sdss3.org}.

The goal of the SDSS spectroscopic pipeline is to produce the
best estimate of spectral intensity as a function of wavelength.
...
\begin{tabular}{ccc}
\hline
Data Release & Instrument & Code version ? \\
\hline
\hline
DR1 & SDSS & ?   \\
DR2 & SDSS & v4\_10\_4   \\
