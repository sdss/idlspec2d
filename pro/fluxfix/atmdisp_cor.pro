...
function atmdisp_cor, loglam, flux, plugtag, hdr, ngroff = ngroff, $
         nrioff = nrioff, title = title, mean_groff = groff_mean, $
         mean_ngroff = ngroff_mean, sig_groff = groff_sig, $
         sig_ngroff = ngroff_sig
