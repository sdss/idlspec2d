...
;;;;;  WARNING: hel. redshift correction
	    ...
	    sample[i].fiberid=id[2]
            ...
            sample[i].mag_psf = photo[good].psfcounts
            sample[i].mag_psferr = photo[good].psfcountserr
            sample[i].fracpsf=photo[good].fracpsf
            sample[i].mag_fiber = photo[good].fibercounts
            sample[i].mag_fibererr = photo[good].fibercountserr
            sample[i].mag_petro = photo[good].petrocounts
            sample[i].mag_petroerr = photo[good].petrocountserr
            ...
            sample[i].mag_model = photo[good].counts_dev
            sample[i].mag_modelerr = photo[good].counts_deverr
            sample[i].mag_dev = photo[good].counts_dev
            sample[i].mag_deverr = photo[good].counts_deverr
            sample[i].mag_exp = photo[good].counts_exp
            sample[i].mag_experr = photo[good].counts_experr
	    ...
	    sample[i].ab_exp = photo[good].ab_exp
            ...
            sample[i].spectype=type 
            sample[i].specprimtar= primtar
            sample[i].specsectar= sectar
