...
;  $Id: sdss_specobjid.pro 130412 2020-06-20 20:42:13Z HJIM modify the plate to 18 bits $
;------------------------------------------------------------------------------
FUNCTION sdss_specobjid_18, plate, fiber, mjd, in_rerun, line=line, index=index
    ...
    ibad= WHERE( plate LT 0 OR plate GE 2L^18 OR $
    ...
    ;
    ul2=ULONG64(2)
    ulplate= ULONG64(plate) AND (ul2^18-1)
