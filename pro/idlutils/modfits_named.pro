...
;
; REVISION HISTORY:
;   06-AUG-2024  Written by Sean Morrison based off of djs_modfits
;-
;-----------------------------------------------------------------------
...
;-----------------------------------------------------------------------
pro modfits_named, filename, thisdata, hdr, exten_no=exten_no, $
 delete_data=delete_data, name=name
