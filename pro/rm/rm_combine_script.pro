...
pro rm_combine_script, planfile, run2d=run2d,skipfluxing=skipfluxing, skipfcorr=skipfcorr, $
     ...
     loaddesi=loaddesi,legacy=legacy,plates=plates,minsn2=minsn2,bscore=bscore;,special=special
...
;   endelse
   rm_spcombine_v5, planfile[i],finaldir=finaldir,xyfit=xyfit, topdir=topdir, $
     ...
     nodist=nodist, loaddesi=loaddesi, legacy=legacy,plates=plates, minsn2=minsn2, bscore=bscore
